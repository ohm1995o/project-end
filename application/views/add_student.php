					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="company">Register Student</a>
							</li>
						...
						<div class="row">
							<div class="col-xs-6">
								...
								<div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
                                    ...
                                    <form action="<?php echo base_url()?>student/registerstd" method="post" class='form-horizontal'>
									...
									<div class="col-xs-12">
												...
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Username </label>
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="text" name="std_user" placeholder="Username" value="<?php echo set_value('box_cd'); ?>" class="width-100" />
																	</span>
																</div>
											</div>
											...
											<div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Password </label>
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="password" name="std_pass" placeholder="Password" value="<?php echo set_value('box_name'); ?>" class="width-100" />
                                            ...
                                            <div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Student Name </label>
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="text" name="std_name" placeholder="Student Name" value="<?php echo set_value('box_name'); ?>" class="width-100" />
                                            ...
                                            <div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Student address </label>
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="text" name="std_address" placeholder="Student address " value="<?php echo set_value('box_name'); ?>" class="width-100" />
                                            ...
                                            <div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Student birthday </label>
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="text" name="std_birthday" placeholder="Student birthday" value="<?php echo set_value('box_name'); ?>" class="width-100" />
																		
																	</span>
																</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Student age</label>  
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="text" name="std_age" placeholder="Student age" value="<?php echo set_value('box_name'); ?>" class="width-100" />
																		
																	</span>
																</div>
                                            </div>
                                            <div class="form-group">
												<label class="col-sm-3 control-label no-padding-right" for="form-field-1">Student sex</label>  
														<div class="col-xs-10 col-sm-6">
																	<span class="block input-icon input-icon-right">
																		<input type="text" name="std_sex" placeholder="Student sex" value="<?php echo set_value('box_name'); ?>" class="width-100" />
